...
<body class="body_filled page page-id-29 page-template-default airsupply_body scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide">
								...
								<ul id="menu_main" class="menu_main_nav">
									...
									<li class="menu-item menu-item-has-children"><a href="#"><span>About NSS</span></a>
										<ul class="sub-menu">
											...
											<li class="menu-item current-menu-item current-menu-ancestor current-menu-parent menu-item-has-children"><a href="benefits.php"><span>Benefits</span></a></li>
										</ul>
									</li>
									
									<li class="menu-item menu-item-has-children"><a href="#"><span>Enrollment</span></a>
										<ul class="sub-menu">
											<li class="menu-item current-menu-item current-menu-ancestor current-menu-parent menu-item-has-children"><a href="requirement.php"><span>Requirements/Eligibility</span></a></li>
											...
											<div class="wrapper">
												...
												<div id="sc_services_1715964234_wrap" class="sc_services_wrap">
												  <div id="sc_services_1715964234" class="sc_services sc_services_style_services-1 sc_services_type_images  margin_top_huge margin_bottom_huge aligncenter">
                                                   ...
                                                   <center><div class="slides swiper-wrapper">
                                                              ...
                                                              <div class="sc_services_item_wrap">
                                                                <div id="sc_services_1715964234_1" class="sc_services_item sc_services_item_1 odd first">
                                                                  ...
                                                                  <div class="sc_services_item_content">
                                                                    <h4 class="sc_services_item_title"><a href="post.php">Retirement Benefits</a></h4>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                            </div>
                                                            <div class="swiper-slide">
                                                              <div class="sc_services_item_wrap">
                                                                <div id="sc_services_1715964234_2" class="sc_services_item sc_services_item_2 even">
                                                                  ...
                                                                  <div class="sc_services_item_content">
                                                                    <h4 class="sc_services_item_title"><a href="post.php">Medicare</a></h4>
                                                                  </div>
                                                                </div>
                                                              </div>
                                                            </div>
												...
												<!-- /.sc_services_wrap -->
															...
															<div class="sc_services_button sc_item_button"><a href="#" class="sc_button sc_button_square sc_button_style_filled sc_button_size_small sc_button_style_color_style2">GET ENROLLED NOW</a></div>
															<p>To provide authentic and timely information of Nigerians that will be used for human developmental activities and social security services.
To promote products and services of companies by making their services, contacts and locations accessible.
</p>
														</div>
														<!-- /.sc_services -->
													</div>
	...
	<script type='text/javascript' src='js/custom/about-style2.js'></script>
