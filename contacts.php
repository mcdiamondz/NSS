													...
													<div class="sc_section sc_section_block margin_top_huge margin_bottom_huge aligncenter column-2_3">
														<div class="sc_section_inner">
															<div class="sc_section_content_wrap">
																<h1 class="block_heading">CONTACT US</h1>
																<p><span class="style2">Contact Address: NSS Towers Head Qrts Nigeria</span>.
																<p>
																<div id="sc_form_224916523_wrap" class="sc_form_wrap">
																	<div id="sc_form_224916523" class="sc_form sc_form_style_form_1 margin_top_medium">
																		<form id="sc_form_224916523_form" class="sc_input_hover_iconed" data-formtype="form_1" method="post" action="">
																			...
																			<div class="sc_form_item sc_form_button"><button type="submit" name="contact_submit" class="contact_form_submit">Send Message</button></div>
