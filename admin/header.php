        ...
        <header id="topnav">
            <div class="topbar-main">
                <div class="container">
                    ...
                    <!-- Logo container-->
                    <div class="logo">
                        <a href="index.html" class="logo"><span><i
                                class="md md-album"></i>NSSS</span></a>
                    </div>
                    <!-- End Logo container-->
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li class="has-submenu">
                                <a href="../dashboard/index.php"><i class="md md-dashboard"></i>Dashboard</a>

                            </li>

                            <li class="has-submenu">
                                <a href="../dashboard/add.php"><i class="md md-account-circle"></i>Add Data</a>
