...
<body class="body_filled page page-id-33 page-template-default airsupply_body scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide">
				...
				<div class="top_panel_wrap_inner top_panel_inner_style_1 top_panel_position_above">
					...
					<div class="top_panel_bottom">
						<div class="content_wrap clearfix">
							...
							<a href="login.php" class="make_appoinment_button sc_button sc_button_square sc_button_style_filled sc_button_size_small sc_button_style_color_style2">Sign in</a>	&nbsp;&nbsp;&nbsp;<a href="getenrolled.php" class="make_appoinment_button sc_button sc_button_square sc_button_style_filled sc_button_size_small sc_button_style_color_style2">Get Enrolled</a>						</div>
					</div>
				</div>
			</header>
